...
// Esperar a que el contenido y las imágenes se carguen completamente
window.onload = function() {
    var buhoImg = document.getElementById('buho-img');
    var tipoeImg = document.getElementById('tipoe-img');
    var txt = document.getElementById('txt'); // Asegúrate de reemplazar 'tu-span' con el ID real de tu span
    
    tipoeImg.style.opacity = '0';
    txt.style.opacity = '0';
    // Después de 4 segundos, mostrar tipoeImg y ocultar buhoImg
    setTimeout(function() {
        buhoImg.style.opacity = '0';
        tipoeImg.style.opacity = '1';
    }, 3000); // 4000 milisegundos = 4 segundos
    
    // Después de 8 segundos, ocultar ambas imágenes y mostrar el texto
    setTimeout(function() {
        tipoeImg.style.opacity = '0';
        txt.style.opacity = '1';
    }, 7000); // 8000 milisegundos = 8 segundos
};
...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Esperar 3 segundos y luego mostrar contents1
	setTimeout(function() {
    ...
    tiposenteroBtn.addEventListener('click', function() {
        ...
        setTimeout(function() {
            document.getElementById('contents').classList.add('hidden');
            document.getElementById('contents1').classList.remove('hidden');
            tipoBtn.textContent = 'entero'; // Restablecer texto del botón tipoBtn
